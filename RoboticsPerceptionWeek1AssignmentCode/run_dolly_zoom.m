%points 應該是指物體的頂點，例如綠色長方體在Figure 3中看來有6個頂點。
%% load data and set parameters
points = load('points.mat');
%%
d_ref = 4; %reference depth
f_ref = 400; %reference focal length
pos = 0 : -0.1 : -9.9; %double represent camera center position in z axis
