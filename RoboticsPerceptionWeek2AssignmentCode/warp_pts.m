...
warped_pts = [];
for  i = 1 : 1 : length(sample_pts(:, 1))
    warped_pts(i, 1) = (H(1, 1)*sample_pts(i, 1) + H(1, 2)*sample_pts(i, 2) + H(1, 3)) / (H(3, 1)*sample_pts(i, 1) + H(3, 2)*sample_pts(i, 2) + H(3, 3));
    warped_pts(i, 2) = (H(2, 1)*sample_pts(i, 1) + H(2, 2)*sample_pts(i, 2) + H(2, 3)) / (H(3, 1)*sample_pts(i, 1) + H(3, 2)*sample_pts(i, 2) + H(3, 3));
end
end
